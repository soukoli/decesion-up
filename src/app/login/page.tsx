  ...
  return (
    <div className="h-dvh flex flex-col items-center justify-center bg-slate-950 px-6">
      ...
      <button
        ...
        className="flex items-center gap-3 px-6 py-3 rounded-xl bg-white text-slate-900 font-medium hover:bg-slate-100 active:scale-95 transition-all shadow-lg"
      >
