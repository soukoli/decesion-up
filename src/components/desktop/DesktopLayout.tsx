      ...
      <aside className="w-64 bg-slate-900/50 border-r border-slate-800 flex flex-col">
        ...
        <div className="p-3 border-t border-slate-800 space-y-2">
          ...
          <button
            ...
            className="relative w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:bg-slate-800 hover:text-white transition-all"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
          ...
          <button
            onClick={onRefresh}
            disabled={refreshing}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:bg-slate-800 hover:text-white transition-all disabled:opacity-50"
          >
